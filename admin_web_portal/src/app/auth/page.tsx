...
import { GraduationCap, ShieldAlert, Key, Mail, Lock } from 'lucide-react';
  ...
  return (
    <main className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 text-white">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        <div className="inline-flex bg-sky-600/20 p-3 rounded-2xl border border-sky-500/30 mb-4">
