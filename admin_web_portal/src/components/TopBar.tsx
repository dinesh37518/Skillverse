...
export default function TopBar({ userEmail }: TopBarProps) {
  ...
  const getBreadcrumbs = () => {
    ...
    return ['Admin Console', ...paths.map(p => p.charAt(0).toUpperCase() + p.slice(1))];
  };
            ...
            <>
              ...
              <div className="absolute right-0 mt-3 w-56 bg-slate-900 border border-slate-800 rounded-xl shadow-xl z-20 py-2 text-sm">
                <div className="px-4 py-3 border-b border-slate-800/60">
                  ...
                  <p className="font-semibold text-white truncate">{userEmail || 'admin@skillverse.ai'}</p>
                </div>
                ...
                <button
                  ...
                  className="w-full flex items-center gap-2.5 px-4 py-2.5 text-slate-400 hover:bg-slate-800 hover:text-white transition-colors cursor-pointer"
                >
                ...
                <button
                  ...
                  className="w-full flex items-center gap-2.5 px-4 py-2.5 text-red-400 hover:bg-red-950/20 hover:text-red-300 transition-colors cursor-pointer"
                >
